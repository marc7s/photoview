...
export interface advancedSearchQuery_search_media_highRes {
  __typename: 'MediaURL'
  /**
   * URL for previewing the image
   */
...
export interface advancedSearchQuery_search_media_videoWeb {
  __typename: 'MediaURL'
  /**
   * URL for previewing the image
   */
...
export interface advancedSearchQuery_search_media {
   ...
   */
  highRes: advancedSearchQuery_search_media_highRes | null
  /**
   * URL to get the video in a web format that can be played in the browser, will be null for photos
   */
  videoWeb: advancedSearchQuery_search_media_videoWeb | null
  favorite: boolean
}
